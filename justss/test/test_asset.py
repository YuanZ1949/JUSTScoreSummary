...
ONETERM_TABLE = '''
<table border="0" cellpadding="0" cellspacing="0"><tr><td height="75" valign="middle"><img id="imgLogo" src="/jsxsd/framework/images/index_logo.gif" style="display:;"/></td></tr></table>,
 ...
 <th class="Nsb_r_list_thb" style="width: 110px;">课程号</th>
 ...
 <th class="Nsb_r_list_thb" style="width: 100px;">课程性质</th>
 <th class="Nsb_r_list_thb" style="width: 60px;">替代课程号</th>
 <th class="Nsb_r_list_thb" style="width: 75px;">替代课程名称</th>
 <th class="Nsb_r_list_thb" style="width: 60px;">成绩标志</th>
 </tr>
 <tr>
 <td>1</td>
 <td>2019-2020-1</td>
 <td align="left">07010011a</td>
 <td align="left">三年级体育专项</td>
 <td style=" ">91</td>
 <td>0.5</td>
 <td>16</td>
 <td>考试</td>
 ...
 <td>3</td>
 <td>2019-2020-1</td>
 <td align="left">30005045b</td>
 <td align="left">蚕丝智慧与农桑文化(校公选社会科学类)</td>
 <td style=" ">优</td>
 <td>2</td>
 <td>32</td>
 <td>考查</td>
